...
export const ChatInput = ({ onSubmit, value, onChange }: ChatInputProps) => {
            ...
            <div className="mx-auto max-w-3xl p-4">
                <form onSubmit={handleSubmit} className="relative">
                    ...
                    <textarea
                        ...
                        className="w-full resize-none rounded-3xl border border-border bg-background px-16 py-4 text-sm outline-none ring-primary/50 placeholder:text-muted-foreground focus:ring-2"
                        rows={1}
                        style={{
                            minHeight: "56px",
                            maxHeight: "200px",
